...
class Changes {
    ...
    private json.app.State state;

    private json.app.Updated_at updated_at;

    private json.app.Total_time_spent total_time_spent;
...
class Object_attributes {
    ...
    private String url;
    private json.app.Source source;
    private json.app.Target target;
